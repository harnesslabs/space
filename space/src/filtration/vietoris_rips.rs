...
//   cloud::Cloud,
//   complexes::{
//     simplicial::{Simplex, SimplicialComplex},
//     Complex,
//   },
...
//   /// 3. The method iterates through all combinations of $k+1$ points for increasing $k$ (from
// $k=1$   ///    up to number of points minus 1).
//   /// 4. Distances are typically squared Euclidean distances for efficiency, so `epsilon` is
// squared   ///    for comparison.
//   pub fn build_complex(&self, cloud: &Cloud<N, F>, epsilon: F) -> Complex<Simplex> {
//     let mut complex = Complex::<Simplex>::new();
...
//       complex.join_element(Simplex::new(0, complex.next_id, vec![i]));
//     }
...
//           complex.join_element(Simplex::new(dim_k, complex.next_id, vertex_indices));
//         }
//       }
//     }
//     complex
...
// #[cfg(feature = "parallel")]
// impl<const N: usize, F> ParallelFiltration for VietorisRips<N, F, Complex<Simplex>>
// where
