...
//!
//! ```rust
//! use cova_space::complexes::Simplex;
//!
...
//!
//! ```rust
//! # use cova_space::{complexes::{SimplicialComplex, Simplex}, prelude::*};
//! # let mut complex = SimplicialComplex::new();
//! # let triangle = Simplex::new(2, vec![0, 1, 2]);
//! # let added = complex.join_element(triangle);
//!
...
//!
//! ```rust
//! # use cova_space::complexes::{SimplicialComplex, Simplex};
//!
...
impl Simplex {
  ...
  /// # Examples
  /// ```rust
  /// # use cova_space::complexes::simplicial::Simplex;
...
mod tests {
  ...
  use cova_algebra::{algebras::boolean::Boolean, modular, prime_field, rings::Field};
